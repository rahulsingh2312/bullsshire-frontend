...
export default function buttonforhero() {
    ...
    <div>
        ...
        <div className="ml-5 md:flex md:mt-7 md:ml-96"><div className='md:ml-56 md:mr-7' style={{ height: '100%', color: 'rgba(231.82, 231.63, 231.63, 0.64)', fontSize: 15, fontFamily: 'Lato', fontWeight: '600', lineHeight: 3, letterSpacing: 0.30, wordWrap: 'break-word'}}>supported on India’s largest brokers</div>
   <Image src={Brokers}/>
   </div>
...
<div className='flex justify-center md:-mt-60 -mt-10 '>
