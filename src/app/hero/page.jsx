...
<div className={`${oxygen}  md:justify-center leading-6 break-words md:mt-96 ml-4   md:text-2xl text-1xl md:flex text-center hidden`}> "Discover curated portfolios and thematic strategies for financial success. Embrace personalized<br/> investment approaches, watch your wealth grow, and embark on a journey to financial<br/> well-being with us."</div>
 
<div className={`${oxygen} flex justify-center leading-6 break-words mt-40 md:mt-96 ml-4   md:text-2xl text-1xl  md:hidden`}> Explore curated portfolios, embrace thematic strategies, and <br/>watch your wealth grow. Your journey to   financial  success begins here.</div>
   <Buttonforhero />
    </div>
    )
    }
